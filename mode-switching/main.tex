...
% ============================================================
\title{
    \textbf{Metacognitive Prompting Produces Spectral Concentration\\
...
Qwen3.5-27B). This supports a real metacognitive geometric signature but
...
spectral concentration grows progressively during generation
...
concentration in the generation-phase cache --- is robust but should be
...
replication on Qwen3.5-27B with reduced collinearity (27\% longer) finds
...
genuine negative effect. The robust finding is spectral concentration
...
The spectral concentration under metacognitive prompting is consistent
...
produces robust, progressive spectral concentration in the generation
