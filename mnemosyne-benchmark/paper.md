...
Single-session factual questions achieve 98.6% accuracy (single-session-user) and 94.6% (single-session-assistant). The weakness is single-session-preference questions (6.7%), which expect meta-answers about user preferences rather than factual recall.
...
|---|---|---|---|---|
| **Mnemosyne v6** | **94.35%** | 77.2% | Token F1 (strict) | Claude Opus 4.6 |
