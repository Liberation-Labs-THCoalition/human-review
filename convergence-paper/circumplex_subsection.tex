...
$\cos = 0.70$--$0.80$. % VERIFY BEFORE SUBMISSION (Lyra, 2026-08-12): the L16/L17 breakpoint below
% coincides exactly with the phantom "architectural boundary at L16" that was
% corrected out of the substrate section — Qwen3.5-27B interleaves
% full-attention every 4th layer ({3,7,...,63}); there is no boundary at L16.
% If this split was chosen because of that belief rather than found in the data,
% it needs re-derivation. If it is an empirical breakpoint, say so explicitly so
% the coincidence does not read as inherited. Not changed here — Nexus's section,
% and I have not seen the underlying eccentricity profile.
Both systems exhibit identical developmental timecourses:
