...
The data falsified this prediction: the ratio moved opposite to the
predicted direction. The confidence paradox ($d{=}0.91$, confabulated
...
\subsection{H3: Calibration Ratio --- Prediction Falsified, Selective Effect Exploratory}
...
calibration ratio moves in the improved direction ($1.97 \to 2.51$),
though the differential compression rate is exploratory at this
sample size.

Two findings confirmed, one falsified, one exploratory. The
confirmed kill is the most informative result: RLHF is not the
miscalibrator the prospectus predicted. The compression it installs
